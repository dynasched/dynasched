...
AC_DEFUN([DSCHED_CHECK_PTHREAD_PIDS],[
#
# Arguments: none
#
# Dependencies: None
#
# Sets:
#  DSCHED_THREADS_HAVE_DIFFERENT_PIDS (variable)
#
# Test for Linux-like threads in the system.  DSCHED does not support
...
DSCHED_VAR_SCOPE_PUSH([tpids_CFLAGS_save tpids_CPPFLAGS_save tpids_LDFLAGS_save tpids_LIBS_save tpids_MSG])
...
[tpids_MSG=no DSCHED_THREADS_HAVE_DIFFERENT_PIDS=0],
[tpids_MSG=yes DSCHED_THREADS_HAVE_DIFFERENT_PIDS=1],
[
 ...
 DSCHED_THREADS_HAVE_DIFFERENT_PIDS=
...
AS_IF([test "x$DSCHED_THREADS_HAVE_DIFFERENT_PIDS" = "x"],
      [ # If we are cross-compiling, look for the symbol
       ...
       AC_CHECK_FUNC([__linuxthreads_create_event],
                     [DSCHED_THREADS_HAVE_DIFFERENT_PIDS=1])])

AS_IF([test "$DSCHED_THREADS_HAVE_DIFFERENT_PIDS" = "1"],
