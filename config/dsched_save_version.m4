...
# DSCHED_SAVE_VERSION(project_short, project-long,
#                  version_file, header_file])
# ----------------------------------------------
# creates version information for project from version_file, using
# DSCHED_GET_VERSION().  Information is AC_SUBSTed and put in
# header_file.
AC_DEFUN([DSCHED_SAVE_VERSION], [
    DSCHED_GET_VERSION([$3], [$1])
