...
dnl Copyright (c) 2025-2026 Nanook Consulting  All rights reserved.
dnl $COPYRIGHT$
dnl
...
dnl $HEADER$
dnl
dnl DSCHED_CONFIG_POSIX_THREADS()
dnl
...
# ********************************************************************
#
# Internal macros - do not call from outside DSCHED_CONFIG_POSIX_THREADS
#
# ********************************************************************


AC_DEFUN([DSCHED_INTL_PTHREAD_TRY_LINK], [
# BEGIN: DSCHED_INTL_PTHREAD_TRY_LINK
#
...
int main(int argc, char* argv[])
{
    ...
    return 0;
                 ...
                 [$1], [$2])
# END: DSCHED_INTL_PTHREAD_TRY_LINK
])dnl
...
#
# ********************************************************************
AC_DEFUN([DSCHED_INTL_POSIX_THREADS_PLAIN_C], [
#
# C compiler
#
if test "$dsched_pthread_c_success" = "0"; then
  AC_MSG_CHECKING([if C compiler and POSIX threads work as is])

  AC_LANG_PUSH(C)
  DSCHED_INTL_PTHREAD_TRY_LINK(dsched_pthread_c_success=1,
                            dsched_pthread_c_success=0)
  AC_LANG_POP(C)
  if test "$dsched_pthread_c_success" = "1"; then
    AC_MSG_RESULT([yes])
  else
    AC_MSG_RESULT([no])
  fi
...
AC_DEFUN([DSCHED_INTL_POSIX_THREADS_PLAIN], [
# BEGIN: DSCHED_INTL_POSIX_THREADS_PLAIN
#
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [DSCHED_INTL_POSIX_THREADS_PLAIN_C],
                  [dsched_pthread_c_success=1])

# End: DSCHED_INTL_POSIX_THREADS_PLAIN
])dnl
...
#
# ********************************************************************
AC_DEFUN([DSCHED_INTL_POSIX_THREADS_SPECIAL_FLAGS_C], [
#
# C compiler
#
if test "$dsched_pthread_c_success" = "0"; then
...
AC_DEFUN([DSCHED_INTL_POSIX_THREADS_SPECIAL_FLAGS],[
# Begin: DSCHED_INTL_POSIX_THREADS_SPECIAL_FLAGS
#
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [DSCHED_INTL_POSIX_THREADS_SPECIAL_FLAGS_C],
                  [dsched_pthread_c_success=1])

# End: DSCHED_INTL_POSIX_THREADS_SPECIAL_FLAGS
])dnl
...
#
# ********************************************************************
AC_DEFUN([DSCHED_INTL_POSIX_THREADS_LIBS_C],[
#
# C compiler
#
if test "$dsched_pthread_c_success" = "0"; then
...
AC_DEFUN([DSCHED_INTL_POSIX_THREADS_LIBS],[
# Begin: DSCHED_INTL_POSIX_THREADS_LIBS
#
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [DSCHED_INTL_POSIX_THREADS_LIBS_C],
                  [dsched_pthread_c_success=1])

# End: DSCHED_INTL_POSIX_THREADS_LIBS]
)dnl
...
#
#********************************************************************
AC_DEFUN([DSCHED_CONFIG_POSIX_THREADS],[
...
DSCHED_INTL_POSIX_THREADS_PLAIN

# Try the super-special compiler flags.
DSCHED_INTL_POSIX_THREADS_SPECIAL_FLAGS

# Try the normal linking methods (that's no fun)
DSCHED_INTL_POSIX_THREADS_LIBS
...
AC_DEFINE_UNQUOTED([DSCHED_HAVE_PTHREAD_MUTEX_ERRORCHECK_NP], [$defval],
...
AC_LINK_IFELSE(
    ...
    [result="yes" defval=1], [result="no" defval=0])
AC_MSG_RESULT([$result])
AC_DEFINE_UNQUOTED([DSCHED_HAVE_PTHREAD_MUTEX_ERRORCHECK], [$defval],
...
unset dsched_pthread_c_success
