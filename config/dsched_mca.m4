...
# with DSCHED's autogen.pl, requiring it's specially formatted lists
...
######################################################################
AC_DEFUN([DSCHED_MCA],[
    dnl for DSCHED_CONFIGURE_USER env variable
    AC_REQUIRE([DSCHED_CONFIGURE_SETUP])
    ...
    AC_ARG_ENABLE(mca-dso,
        AS_HELP_STRING([--enable-mca-dso=LIST],
                       [Comma-separated list of types and/or
                        ...
                        platform.] The default is to build all
                        components as run-time loadable.),
                        [], [enable_mca_dso=all])
...
*** of type-component pairs.  For example, --enable-mca-no-build=pcompress-zlib])
    else
        ifs_save="$IFS"
    ...
    elif test "$DSCHED_ENABLE_DLOPEN_SUPPORT" = 0; then
        DSO_all=0
    ...
    # now configure the DSCHED project.  Most
    ...
    dsched_show_subtitle "Configuring MCA"

    AC_MSG_CHECKING([for frameworks])
    AC_MSG_RESULT([mca_dsched_framework_list])
    ...
    m4_ifdef([mca_dsched_framework_list], [],
             [m4_fatal([Could not find mca_dsched_framework_list - please rerun autogen.pl])])

    MCA_dsched_FRAMEWORKS=
    MCA_dsched_FRAMEWORKS_SUBDIRS=
    MCA_dsched_FRAMEWORK_COMPONENT_ALL_SUBDIRS=
    MCA_dsched_FRAMEWORK_COMPONENT_DSO_SUBDIRS=
    MCA_dsched_FRAMEWORK_COMPONENT_STATIC_SUBDIRS=
    MCA_dsched_FRAMEWORK_LIBS=

    m4_foreach(mca_framework, [mca_dsched_framework_list],
               [m4_ifval(mca_framework,
                         [dnl common has to go up front
                          m4_if(mca_framework, [common],
                                [MCA_dsched_FRAMEWORKS="mca_framework $MCA_dsched_FRAMEWORKS"
                                 MCA_dsched_FRAMEWORKS_SUBDIRS="[mca/]mca_framework $MCA_dsched_FRAMEWORKS_SUBDIRS"
                                 MCA_dsched_FRAMEWORK_COMPONENT_ALL_SUBDIRS="[\$(MCA_dsched_]mca_framework[_ALL_SUBDIRS)] $MCA_dsched_FRAMEWORK_COMPONENT_ALL_SUBDIRS"
                                 MCA_dsched_FRAMEWORK_COMPONENT_DSO_SUBDIRS="[\$(MCA_dsched_]mca_framework[_DSO_SUBDIRS)] $MCA_dsched_FRAMEWORK_COMPONENT_DSO_SUBDIRS"
                                 MCA_dsched_FRAMEWORK_COMPONENT_STATIC_SUBDIRS="[\$(MCA_dsched_]mca_framework[_STATIC_SUBDIRS)] $MCA_dsched_FRAMEWORK_COMPONENT_STATIC_SUBDIRS"
                                ], [
                                 MCA_dsched_FRAMEWORKS="$MCA_dsched_FRAMEWORKS mca_framework"
                                 MCA_dsched_FRAMEWORKS_SUBDIRS="$MCA_dsched_FRAMEWORKS_SUBDIRS [mca/]mca_framework"
                                 MCA_dsched_FRAMEWORK_COMPONENT_ALL_SUBDIRS="$MCA_dsched_FRAMEWORK_COMPONENT_ALL_SUBDIRS [\$(MCA_dsched_]mca_framework[_ALL_SUBDIRS)]"
                                 MCA_dsched_FRAMEWORK_COMPONENT_DSO_SUBDIRS="$MCA_dsched_FRAMEWORK_COMPONENT_DSO_SUBDIRS [\$(MCA_]dsched[_]mca_framework[_DSO_SUBDIRS)]"
                                 MCA_dsched_FRAMEWORK_COMPONENT_STATIC_SUBDIRS="$MCA_dsched_FRAMEWORK_COMPONENT_STATIC_SUBDIRS [\$(MCA_dsched_]mca_framework[_STATIC_SUBDIRS)]"
                                 MCA_dsched_FRAMEWORK_LIBS="$MCA_dsched_FRAMEWORK_LIBS [mca/]mca_framework[/libdschedmca_]mca_framework[.la]"])
                          MCA_dsched_FRAMEWORK_LIBS="$MCA_dsched_FRAMEWORK_LIBS [\$(MCA_dsched_]mca_framework[_STATIC_LTLIBS)]"
                          m4_ifdef([MCA_dsched_]mca_framework[_CONFIG],
                                   [MCA_dsched_]mca_framework[_CONFIG](mca_framework),
                                   [MCA_CONFIGURE_FRAMEWORK(mca_framework, 1)])])])

    AC_SUBST(MCA_dsched_FRAMEWORKS)
    AC_SUBST(MCA_dsched_FRAMEWORKS_SUBDIRS)
    AC_SUBST(MCA_dsched_FRAMEWORK_COMPONENT_ALL_SUBDIRS)
    AC_SUBST(MCA_dsched_FRAMEWORK_COMPONENT_DSO_SUBDIRS)
    AC_SUBST(MCA_dsched_FRAMEWORK_COMPONENT_STATIC_SUBDIRS)
    AC_SUBST(MCA_dsched_FRAMEWORK_LIBS)
...
AC_DEFUN([MCA_ORDER_COMPONENT_LIST], [
    m4_foreach(mca_component, [mca_dsched_$1_m4_config_component_list],
               [m4_ifval(mca_component,
                    [m4_ifdef([MCA_dsched_]$1[_]mca_component[_PRIORITY], [],
                         [m4_fatal([MCA_dsched_$1_]mca_component[_PRIORITY not found, but required.])])])])
    m4_define([component_list],
              [esyscmd([config/dsched_mca_priority_sort.pl] m4_foreach([mca_component], [mca_dsched_$1_m4_config_component_list],
                        [m4_ifval(mca_component, [mca_component ]DSCHED_EVAL_ARG([MCA_dsched_]$1[_]mca_component[_PRIORITY ]))]))])
])
...
AC_DEFUN([MCA_CHECK_IGNORED_PRIORITY], [
    m4_foreach(mca_component, [mca_dsched_$1_m4_config_component_list],
               [m4_ifval(mca_component,
                    [m4_ifdef([MCA_dsched_]$1[_]mca_component[_PRIORITY],
                         [m4_warn([unsupported], [MCA_dsched_]$1[_]mca_component[_PRIORITY found, but ignored.])])])])
])
...
AC_DEFUN([MCA_CONFIGURE_FRAMEWORK],[
    dsched_show_subsubtitle "Configuring MCA framework $1"

    m4_ifdef([mca_dsched_$1_no_config_component_list], [],
             [m4_fatal([Could not find mca_dsched_$1_no_config_component_list - please rerun autogen.pl])])
    m4_ifdef([mca_dsched_$1_m4_config_component_list], [],
             [m4_fatal([Could not find mca_dsched_$1_m4_config_component_list - please rerun autogen.pl])])
    ...
    m4_foreach(mca_component, [mca_dsched_$1_no_config_component_list],
               [m4_ifval(mca_component,
    ...
    m4_if(DSCHED_EVAL_ARG([MCA_dsched_$1_CONFIGURE_MODE]), [STOP_AT_FIRST], [MCA_ORDER_COMPONENT_LIST($1)],
          [m4_if(DSCHED_EVAL_ARG([MCA_dsched_$1_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY], [MCA_ORDER_COMPONENT_LIST($1)],
                [m4_if(DSCHED_EVAL_ARG([MCA_dsched_$1_CONFIGURE_MODE]), [PRIORITY], [MCA_ORDER_COMPONENT_LIST($1)],
                       [m4_define([component_list], [mca_dsched_$1_m4_config_component_list])])])])
    ...
    m4_foreach(mca_component, [component_list],
               [m4_ifval(mca_component,
                  [m4_if(DSCHED_EVAL_ARG([MCA_dsched_$1_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY],
                         [AS_IF([test $best_mca_component_priority -gt MCA_dsched_$1_]mca_component[_PRIORITY], [components_looking_for_succeed=0])])
                   ...
                   m4_if(DSCHED_EVAL_ARG([MCA_dsched_$1_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY],
                         [AS_IF([test $components_last_result -eq 1], [best_mca_component_priority=]DSCHED_EVAL_ARG([MCA_dsched_$1_]mca_component[_PRIORITY]))])
                   ])])

    # configure components that provide their own configure script.
    # It would be really hard to run these for "find first that
    # works", so we don't :)
    m4_if(DSCHED_EVAL_ARG([MCA_dsched_]$1[_CONFIGURE_MODE]), [STOP_AT_FIRST], [],
        [m4_if(DSCHED_EVAL_ARG([MCA_dsched_]$1[_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY], [],
             [m4_if(DSCHED_EVAL_ARG([MCA_dsched_]$1[_CONFIGURE_MODE]), [PRIORITY], [],
    ...
    MCA_dsched_$1_ALL_COMPONENTS="$all_components"
    MCA_dsched_$1_STATIC_COMPONENTS="$static_components"
    MCA_dsched_$1_DSO_COMPONENTS="$dso_components"
    MCA_dsched_$1_STATIC_LTLIBS="$static_ltlibs"

    AC_SUBST(MCA_dsched_$1_ALL_COMPONENTS)
    AC_SUBST(MCA_dsched_$1_STATIC_COMPONENTS)
    AC_SUBST(MCA_dsched_$1_DSO_COMPONENTS)
    AC_SUBST(MCA_dsched_$1_STATIC_LTLIBS)

    DSCHED_MCA_MAKE_DIR_LIST(MCA_dsched_$1_ALL_SUBDIRS, $1, [$all_components])
    DSCHED_MCA_MAKE_DIR_LIST(MCA_dsched_$1_STATIC_SUBDIRS, $1, [$static_components])
    DSCHED_MCA_MAKE_DIR_LIST(MCA_dsched_$1_DSO_SUBDIRS, $1, [$dso_components])
...
const pmix_mca_base_component_t **dsched_mca_$1_base_static_components[[]] = {
`cat $outfile.struct`
  NULL
};
...
AC_DEFUN([MCA_CONFIGURE_NO_CONFIG_COMPONENT],[
    dsched_show_subsubsubtitle "MCA component $1:$2 (no configuration)"

    dsched_show_verbose "DSCHED_MCA_NO_CONFIG_COMPONENT: before, should_build=$7"
    MCA_COMPONENT_BUILD_CHECK($1, $2,
                              [should_build=$7], [should_build=0])
    MCA_COMPONENT_COMPILE_MODE($1, $2, compile_mode)
    dsched_show_verbose "DSCHED_MCA_NO_CONFIG_COMPONENT: after, should_build=$should_build"
    ...
    if test "$compile_mode" = "dso" ; then
        BUILD_dsched_$1_$2_DSO=1
    else
        BUILD_dsched_$1_$2_DSO=0
    fi
    AM_CONDITIONAL(MCA_BUILD_dsched_$1_$2_DSO, test "$BUILD_dsched_$1_$2_DSO" = "1")
...
AC_DEFUN([MCA_CONFIGURE_M4_CONFIG_COMPONENT],[
    m4_ifdef([MCA_dsched_$1_$2_PRIORITY],
        [dsched_show_subsubsubtitle "MCA component $1:$2 (m4 configuration macro, priority MCA_dsched_$1_$2_PRIORITY)"],
        [dsched_show_subsubsubtitle "MCA component $1:$2 (m4 configuration macro)"])

    dsched_show_verbose "DSCHED_MCA_M4_CONFIG_COMPONENT: before, should_build=$7"
    ...
    m4_ifdef([MCA_dsched_$1_$2_COMPILE_MODE],
             [MCA_dsched_$1_$2_COMPILE_MODE($1, $2, compile_mode)],
             [MCA_COMPONENT_COMPILE_MODE($1, $2, compile_mode)])

    # try to configure the component
    m4_ifdef([MCA_dsched_$1_$2_CONFIG],
             [MCA_dsched_$1_$2_CONFIG([should_build=$should_build],
                                  [should_build=0])],
             [m4_fatal([MCA_dsched_$1_$2_CONFIG macro not found])])
    dsched_show_verbose "DSCHED_MCA_M4_CONFIG_COMPONENT: after, should_build=$should_build"
    ...
    m4_ifdef([MCA_dsched_$1_$2_POST_CONFIG],
             [ MCA_dsched_$1_$2_POST_CONFIG($should_build)])
...
AC_DEFUN([MCA_CONFIGURE_ALL_CONFIG_COMPONENTS],[
    for component_path in $srcdir/src/mca/$1/* ; do
        ...
        if test -d $component_path && test -x $component_path/configure ; then
            dsched_show_subsubsubtitle "MCA component $1:$component (need to configure)"

            dsched_show_verbose "DSCHED_MCA_ALL_CONFIG_COMPONENTS: before, should_build=$7"
            MCA_COMPONENT_BUILD_CHECK($1, $component,
                                      [should_build=1], [should_build=0])
            MCA_COMPONENT_COMPILE_MODE($1, $component, compile_mode)
            dsched_show_verbose "DSCHED_MCA_ALL_CONFIG_COMPONENTS: after, should_build=$should_build"

            if test "$should_build" = "1" ; then
                DSCHED_CONFIG_SUBDIR([src/mca/$1/$component],
                                   [$dsched_subdir_args],
                                   [should_build=1], [should_build=0])
                dsched_show_verbose "DSCHED_MCA_ALL_CONFIG_COMPONENTS: after subdir, should_build=$should_build"
            fi
...
# DSCHED_MCA_STRIP_LAFILES(output_variable(1),
#                        input_list(2)
#--------------------------------------------
...
AC_DEFUN([DSCHED_MCA_STRIP_LAFILES], [
    DSCHED_VAR_SCOPE_PUSH([dsched_tmp])

    $1=
    for arg in $2; do
	dsched_tmp=`echo $arg | awk '{print substr([$][1], length([$][1])-2) }'`
        AS_IF([test "$dsched_tmp" != ".la"],
              [DSCHED_APPEND([$1], [$arg])])
    done
...
AC_DEFUN([MCA_PROCESS_COMPONENT],[
    ...
    if test "$7" = "dso" ; then
        ...
        if test "$1" = "common"; then
            ...
            # set.
            $6="mca/$1/$2/lib${m4_translit([dsched], [a-z], [A-Z])_LIB_PREFIX}dsched_mca_$1_$2.la $$6"
        else
            # Other frameworks do not have to obey the
            # $FRAMEWORK_LIB_PREFIX prefix.
            $6="mca/$1/$2/libdsched_mca_$1_$2.la $$6"
        fi
        echo "extern const pmix_mca_base_component_t *dsched_mca_$1_$2_component_ptr;" >> $outfile.extern
        echo "  &dsched_mca_$1_$2_component_ptr, " >> $outfile.struct
        $4="$$4 $2"
    fi
    ...
    AS_IF([test "$7" = "static"],
          [AS_VAR_SET_IF([$1_$2_WRAPPER_EXTRA_LDFLAGS],
           ...
           DSCHED_FLAGS_APPEND_UNIQ([dsched_mca_wrapper_extra_ldflags], [$tmp_flags])
           ...
           DSCHED_FLAGS_APPEND_UNIQ([dsched_mca_wrapper_extra_static_ldflags], [$tmp_flags])
           ...
           DSCHED_APPEND_UNIQ([dsched_mca_wrapper_extra_pc_modules], [$tmp_flags])

           AS_VAR_SET_IF([$1_$2_WRAPPER_EXTRA_LIBS],
              [AS_VAR_COPY([tmp_flags], [$1_$1_WRAPPER_EXTRA_LIBS])],
              [AS_VAR_COPY([tmp_all_flags], [$1_$2_LIBS])
               DSCHED_MCA_STRIP_LAFILES([tmp_flags], [$tmp_all_flags])])
           DSCHED_FLAGS_APPEND_MOVE([dsched_mca_wrapper_extra_libs], [$tmp_flags])
           ...
           DSCHED_FLAGS_APPEND_MOVE([dsched_mca_wrapper_extra_static_libs], [$tmp_flags])])
    ...
    AS_LITERAL_IF([$2],
        [AS_IF([test "$$1_$2_WRAPPER_EXTRA_CPPFLAGS" != ""],
           [m4_if(DSCHED_EVAL_ARG([MCA_$1_CONFIGURE_MODE]), [STOP_AT_FIRST], [stop_at_first=1], [stop_at_first=0])
            AS_IF([test "$8" = "static" && test "$stop_at_first" = "1"],
              [AS_IF([test "$with_devel_headers" = "yes"],
                     [DSCHED_FLAGS_APPEND_UNIQ([dsched_mca_wrapper_extra_cppflags], [$$2_$3_WRAPPER_EXTRA_CPPFLAGS])])],
...
AC_DEFUN([MCA_COMPONENT_BUILD_CHECK],[
    ...
    # build if:
    # - there is no dsched_ignore file
    # - there is an dsched_ignore, but there is an empty dsched_unignore
    # - there is an dsched_ignore, but username is in dsched_unignore
    if test -d $component_path ; then
        ...
        want_component=1
        if test -f $component_path/.dsched_ignore ; then
            # If there is an dsched_ignore file, don't build
            # the component.  Note that this decision can be
            # overridden by the unignore logic below.
            want_component=0
        fi
        if test -f $component_path/.dsched_unignore ; then
            # if there is an empty dsched_unignore, that is
            # equivalent to having your userid in the unignore file.
            # If userid is in the file, unignore the ignore file.
            if test ! -s $component_path/.dsched_unignore ; then
                want_component=1
            elif test ! -z "`$GREP $DSCHED_CONFIGURE_USER $component_path/.dsched_unignore`" ; then
                want_component=1
            fi
        fi
    fi
...
# DSCHED_MCA_MAKE_DIR_LIST(subst'ed variable, framework, shell list)
# -------------------------------------------------------------------------
AC_DEFUN([DSCHED_MCA_MAKE_DIR_LIST],[
    $1=
    for item in $3 ; do
       $1="$$1 mca/$2/$item"
    done
