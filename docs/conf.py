...
project = 'DynaSched'
copyright = f'2014-{year}, DynaSched Community'
...
for dsched_line in dsched_lines:
    if '#' in dsched_line or 0 == len(dsched_line):
        continue
...
hwloc_min_version = f"{dsched_data['hwloc_min_version']}"
event_min_version = f"{dsched_data['event_min_version']}"
automake_min_version = f"{dsched_data['automake_min_version']}"
autoconf_min_version = f"{dsched_data['autoconf_min_version']}"
