...
#ifndef DSCHED_PREFETCH_H
#define DSCHED_PREFETCH_H

#include "dsched_config.h"

/* C code */

#if DSCHED_C_HAVE_BUILTIN_EXPECT
...
#if DSCHED_C_HAVE_BUILTIN_PREFETCH
#    define DSCHED_PREFETCH(address, rw, locality) __builtin_prefetch(address, rw, locality)
#else
#    define DSCHED_PREFETCH(address, rw, locality)
#endif
