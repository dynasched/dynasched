...
#ifndef DSCHED_HASH_STRING_H
#define DSCHED_HASH_STRING_H
 ...
 */
#define DSCHED_HASH_STRLEN(str, hash, length) \
    do {                                    \
 ...
 *  @param hash (OUT)   Where the hash value will be stored (uint32_t)
 */
#define DSCHED_HASH_STR(str, hash)           \
    do {                                   \
        register const char *_str = (str); \
        register uint32_t _hash = 0;       \
                                           \
