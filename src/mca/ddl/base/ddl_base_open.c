...
#include "src/mca/ddl/base/static-components.h"

/*
 * Globals
 */
dsched_ddl_base_module_t *dsched_ddl = NULL;
dsched_ddl_base_component_t *dsched_ddl_base_selected_component = NULL;
...
int dsched_ddl_base_open(pmix_mca_base_open_flag_t flags)
{
    ...
    return pmix_mca_base_framework_components_open(&dsched_ddl_base_framework, flags);
}
...
/* VERY IMPORTANT: This framework is static, and is opened before any
   ...
   framework. */
PMIX_MCA_BASE_FRAMEWORK_DECLARE(dsched, ddl, "Dynamic loader framework", NULL /* register */,
                                dsched_ddl_base_open /* open */, NULL /* close */,
                                dsched_mca_ddl_base_static_components,
